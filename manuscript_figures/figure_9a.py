...
SOURCE_PDF = PLOT_DIR / "grid6" / MODEL_ID / "wcd_reduction" / f"grid6_wcd_reduction_ratio_{RATIO_ID}.pdf"
...
def run_generation() -> Path:
    ...
    if _has_raw_data(grid_size=6):
        print("[figure_9a] Running prepare_data_for_analysis.py (grid 6)", flush=True)
    ...
    print("[figure_9a] Running analyse_and_plot.py (grid 6)", flush=True)
