...
SOURCE_PDF = PLOT_DIR / "grid13" / MODEL_ID / "wcd_reduction" / "grid13_wcd_reduction_uniform_cost.pdf"
...
def run_generation() -> Path:
    ...
    if _has_raw_data(grid_size=13):
        print("[figure_4a] Running prepare_data_for_analysis.py (grid 13)", flush=True)
    ...
    print("[figure_4a] Running analyse_and_plot.py (grid 13)", flush=True)
