...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate Figure 6b.")
    parser.add_argument(
        "--preflight-only",
        action="store_true",
    ...
    if args.preflight_only:
        ...
        if not ok:
            ...
            raise SystemExit(
                "Figure 6b preflight failed. Missing inputs:\n"
                f"{formatted}"
            )
        print("[figure_6b] Preflight checks passed.")
    else:
        main()
