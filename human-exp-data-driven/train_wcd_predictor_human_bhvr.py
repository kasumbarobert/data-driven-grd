...
model = CustomCNN(n_channels=x_test.shape[1],drop_out=dropout,size = GRID_SIZE//2).to(device) #
...
sns.kdeplot(best_model(x_test.to(device)).cpu().detach().numpy(), fill=True, color='blue', label="Pred")
