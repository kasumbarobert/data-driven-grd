...
HOW IT WORKS:
1. Loads training data generated by simulate_training_data_overcooked.py
...
- Regularization: L2 regularization (λ=0.1) to prevent overfitting
- Scheduler: MultiStepLR with milestones at epochs 12, 25, 45, 55
- Training: 20 epochs with batch size 8192

USAGE:
    python train_wcd_predictor_overcooked.py --train --grid_size 6
