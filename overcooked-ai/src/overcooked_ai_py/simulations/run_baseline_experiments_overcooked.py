...
USAGE:
    python run_baseline_experiments_overcooked.py --cost 10 --max_grid_size 6 --experiment_label test --experiment_type GREEDY_TRUE_WCD --optimality OPTIMAL --start_index 0 --timeout_seconds 18000 --ratio 1_3
